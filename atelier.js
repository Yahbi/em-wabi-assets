...
function openOrder(p){if(HANDLES[p]){location.href='/products/'+HANDLES[p];return;}_set('mk','Enquire · reserve this piece');_set('mph','Reserve: '+p);_set('msub','This piece is made to order. Send your details and a dedicated advisor will email you within 24 hours to begin — stone selection, then a secure Shopify payment link.');_setv('m-kind','Reserve / enquiry');_setv('m-piece',p);_set('msubmit','Send enquiry');_set('mprom','Made to order · shipped worldwide · we reply within 24 hours');_openM();}
